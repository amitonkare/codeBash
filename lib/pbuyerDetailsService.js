      ...
      return {
        ...
        updateBuyer : function (id,buyerName,buyerAddress,buyerPhoneNo,buyerEmailId,buyerBankName,branch,IFSC,accountNumber) {
          ...
          if(buyerBankName)
          {
             ...
             ob2.branch = obj3.bankAccoutDetails.branch;
             ob2.IFSCCode =  obj3.bankAccoutDetails.IFSCCode;
             ob2.accountNumber = obj3.bankAccoutDetails.accountNumber;
             console.log(ob2);
             BuyerDetails.update(key,{$set:{bankAccoutDetails:ob2}});
          }
          if(branch)
          {
             var obj = BuyerDetails.find({_id:id}).fetch();
             ...
             console.log(obj3);
             var ob2 = {};
             ob2.bankName = obj3.bankAccoutDetails.bankName;
             ob2.branch = branch;
             ob2.IFSCCode =  obj3.bankAccoutDetails.IFSCCode;
             ob2.accountNumber = obj3.bankAccoutDetails.accountNumber;
             console.log(ob2);
